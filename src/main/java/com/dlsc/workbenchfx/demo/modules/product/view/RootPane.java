...
public class RootPane extends BorderPane implements ViewMixin {
    ...
    public void setupValueChangedListeners() {
        model.getFormInstance().changedProperty().addListener((observable, oldValue, newValue) ->{Log.info(newValue); changedLabel.setText("The form has " + (newValue ? "" : "not ") + "changed.");model.getFormInstance().persist();});
        ...
        model.getCountry().allCapitalsProperty().addListener((observable, oldValue, newValue) -> populationLabel.setText("Population: " + newValue));
    }
    ...
    public void layoutParts() {
        ...
        //topControls.setPrefHeight(100);
        //topControls.getStyleClass().add("bordered");
