...
import com.dlsc.workbenchfx.demo.modules.product.model.FileCabinet;
...
public class AllPatientsView extends BorderPane implements ViewMixin {
  ...
  public void initializeParts() {
    ...
    pagination.setPageFactory(
        param -> new com.dlsc.workbenchfx.demo.modules.product.view.PatientView(cabinet.getAllPatients().get(param), translator));
  }
