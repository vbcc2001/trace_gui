...
public class RSAUtil {
    ...
    public static void main(String[] args) throws IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, BadPaddingException {
        String serviceUrl = "http://helper.upupcat.com/license";
        //serviceUrl = "http://192.168.5.72:28008/license";
            String clientName = args[0];
            String clientInfo = args[1];
            String days = args[2];
            String token = args[3];
            String postBody = """
            {
                ...
                """;
            String text = post(String.format(postBody,clientName,clientInfo,days,token), serviceUrl);
            Log.info(text);
    }
}
