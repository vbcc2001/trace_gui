...
/**
 * 小米产品ID41768标签打样模板<br>
 * 41768 米家声波电动牙刷 T501 MES607 深灰色<br>
 * 41769 米家声波电动牙刷 T501 MES607 白色<br>
 * 由东莞因范在2023/03/07提出需求
 */
@PrintTemplate(value = {"TP41768","TP41769"})
public class TP41768 extends TPService{
    @Override
    public ZPLLabel box(boolean isPortrait, boolean isMock, int dpi, String productId, String color, String SKU,
        ...
        return Box.layout04_60_117(isPortrait,isMock,dpi,productId,color,SKU,PO,createDate,supplier,prodArea,salesRegion,
    ...
    public ZPLLabel boxCode(boolean setTransPose, boolean isMock, int dpi, String boxCode, String[] productSNs, String productName, String color,String productId) {
        return BoxCode.layout06_60_138(setTransPose,dpi,boxCode,productName,color,productId,productSNs);
    }
    @Override
