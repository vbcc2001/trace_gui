...
//        cell.setHeight(UnitValue.createPercentValue(60));
	...
	public static void manipulatePdf(String targetPath, String fromArea, String toArea, String barCode) throws IOException, URISyntaxException {
		...
		try (Document doc=new Document(demo.getPdfDoc());){
			demo.addText("出货地", fromArea);
			demo.addText("目的地", toArea);
			demo.addBarCode(barCode);
